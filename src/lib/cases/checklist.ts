...
const TEMPLATES: Record<string, Array<{ key: string; label: string }>> = {
  ...
  "telefon-gorusme": [
    { key: "slot_booked", label: "Görüşme saati teyit" },
    { key: "call_done", label: "Görüşme yapıldı" },
    { key: "summary_shared", label: "Müşteri dilinde not paylaşıldı" },
    { key: "result_uploaded", label: "Sonuç yüklendi (isteğe bağlı)" },
  ],
  "yerinde-eslik": [
    { key: "city_confirmed", label: "Şehir / kurum teyit" },
    { key: "slot_booked", label: "Randevu saati teyit" },
    { key: "onsite_done", label: "Yerinde eşlik yapıldı" },
    { key: "summary_shared", label: "Müşteri dilinde not paylaşıldı" },
  ],
};

...
describe("brandedFileName", () => {
  it("appends ROUTEPOL once", () => {
    expect(brandedFileName("ceviri.pdf")).toBe("ceviri_ROUTEPOL.pdf");
    expect(brandedFileName("ceviri_ROUTEPOL.pdf")).toBe("ceviri_ROUTEPOL.pdf");
  });
});

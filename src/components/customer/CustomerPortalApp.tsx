...
function labels(locale: string) {
  const tr = {
    ...
    renewPack: "Aylık abonelik başlat",
    ...
    skuAylikBody:
      "Stripe abonelik: ay boyunca gelen yazılar; karttan otomatik yenilenir; kota net.",
    skuAylikPrice: "160 zł’den / ay",
    skuSurec: "Vekaletli idari yürütme",
    skuSurecBody:
      "Stripe abonelik: noter idari vekaletiyle evrak ve randevu; karttan otomatik yenilenir.",
    skuSurecPrice: "650 zł’den / ay",
    openCase: "Aç / indir",
    noPeriod: "Aktif aylık abonelik yok.",
    queued:
      "Sonraki dönem kuyrukta — mevcut dönem bitince otomatik başlar.",
    renewHint:
      "Aktif abonelik yoksa aylık abonelik başlatın — bilgileriniz hazır dolacak.",
    statusReady: "Hazır",
  ...
  if (locale === "pl") {
    return {
      ...
      logout: "Wyloguj",
      renewPack: "Uruchom abonament miesięczny",
      period: "Abonament miesięczny",
      ...
      skuAylikBody:
        "Abonament Stripe: pisma w ciągu miesiąca; odnowienie kartą automatyczne; limit jasny.",
      skuAylikPrice: "od 160 zł / mc",
      skuSurec: "Pełnomocnictwo administracyjne",
      skuSurecBody:
        "Abonament Stripe: koordynacja pism i wizyt z pełnomocnictwem; odnowienie kartą automatyczne.",
      skuSurecPrice: "od 650 zł / mc",
      noPeriod: "Brak aktywnego abonamentu miesięcznego.",
      renewHint:
        "Bez aktywnego abonamentu — uruchomcie abonament miesięczny; dane uzupełnią się same.",
  ...
  if (locale === "en") {
    return {
      ...
      logout: "Sign out",
      renewPack: "Start monthly subscription",
      ...
      skuAylikBody:
        "Stripe subscription: letters through the month; card auto-renews; quota is clear.",
      skuAylikPrice: "from 160 zł / mo",
      skuSurec: "Mandate admin track",
      skuSurecBody:
        "Stripe subscription: papers and appointments with a notarial admin POA; card auto-renews.",
      skuSurecPrice: "from 650 zł / mo",
      noPeriod: "No active monthly subscription.",
      renewHint:
        "If you have no active subscription, start a monthly subscription — your details pre-fill.",

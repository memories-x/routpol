...
export function DanismanlikPageView({ locale, content }: Props) {
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-14 sm:px-6 md:py-20">
      ...
      <PtReveal delay={0.06} className="mt-14">
        <h2 className="font-display text-xl font-semibold text-pt-navy-950">
      ...
      <PtReveal delay={0.04} className="mt-14">
        <h2 className="font-display text-xl font-semibold text-pt-navy-950">
      ...
      <PtReveal className="mt-12 flex flex-wrap items-center gap-x-5 gap-y-3">
        <SmartLink

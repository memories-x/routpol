...
/**
 * Quiet Authority shell + Hostinger section rhythm (Tur 2).
 * Order: Hero → Scope → Bridge → Audiences → Packages → Process → FAQ → Lead
 */
export function LandingPage({ content, site, locale }: Props) {
  return (
    <>
      ...
      <LandingAudiences content={content} locale={locale} />

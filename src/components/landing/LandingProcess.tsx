...
/**
 * Editorial steps + Stripe easing craft.
 */
export function LandingProcess({ content, locale }: Props) {
  ...
  const reduce = !motionReady || Boolean(reducePref);
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <ol className="mt-10 space-y-0">
          {steps.map((step, i) => (
            ...
            >
              <span className="flex h-9 w-9 items-center justify-center rounded-full bg-pt-emerald-600 text-sm font-bold text-white shadow-[0_8px_16px_-8px_rgba(5,150,105,0.7)]">
                {i + 1}
              </span>
              <div>
        ...
        <PtReveal delay={0.08} className="mt-16">
          <div className="rounded-2xl border border-pt-emerald-600/15 bg-pt-emerald-50/60 px-6 py-8 md:px-10 md:py-10">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-5 gap-y-3">
              <SmartLink
                href={`/${locale}/basvuru?paket=yerinde-eslik`}
              ...
              <SmartLink
                ...
                className="text-sm font-semibold text-pt-navy-900 transition-colors hover:text-pt-emerald-700"
              >

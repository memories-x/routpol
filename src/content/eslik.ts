...
export const eslikTr: ServiceDetailContent = {
  meta: {
    ...
    description:
      "Banka, PESEL, ehliyet, oturum kartı, sağlık raporu ve urząd randevularında dil köprüsü; uzaktan, telefon veya yerinde. Firma ve şahıs. Onay garantisi değildir.",
  },
  eyebrow: "Yerinde eşlik · firma & şahıs",
  title: "Kurumlar arası süreçte yanınızdayız",
  lead:
    "KOBİ ve şahıs işlerinde yazı özeti yetmeyebilir: lojistik evrakı, banka, PESEL, ehliyetin Polonya ehliyetine çevrilmesi, oturum kartı, urząd. Uzaktan, telefonla veya yerinde eşlik. Diller: Türkçe, Lehçe, İngilizce, Rusça, Ukraynaca.",
  positioning:
    "Biz avukat, yeminli tercüman veya banka/sağlık kurumu değiliz. Karar ilgili mercidedir. ROUTEPOL aracı danışmandır: evrak sırası, randevu, dilde bilgi, avukat ortağına köprü ve — istenirse — yerinde eşlik.",
  ...
  who: [
    ...
    },
    {
      ...
      body: "Polonya’daki Türkler: PESEL, oturum kartı, ehliyet çevirisi, sağlık raporu, urząd — uzaktan, telefon veya yerinde.",
    },
  ],
  workstreamsTitle: "İş kalemleri",
  workstreamsIntro:
    "Dosyaya göre değişir; sonuç veya onay taahhüt edilmez. Yoğun veya vekaletli işlerde Vekaletli idari yürütme kullanılır.",
  workstreams: [
    {
      title: "Firma hattı",
    ...
    },
    {
      ...
      items: [
        "PESEL başvurusu — evrak checklist ve randevu sırası",
        "Yabancı ehliyetin Polonya ehliyetine çevrilmesi — adımlar, evrak, urząd (karar mercidedir)",
  ...
  packagesIntro:
    "Satılan ürünler: yazı paketleri ve yerinde eşlik (yarı gün). Telefon görüşmesi şu an sunulmuyor. Yoğun dönem için vekaletli paket ayrıdır.",
  packages: [
    {
      slug: "yerinde-eslik",
      title: "Yerinde eşlik (yarı gün)",
      role: "Ofis / banka / urząd — 1 kurum, Polonya geneli taban 450 zł; şehir dışı ulaşım ayrıca.",
      href: "/hizmetler/yerinde-eslik",
    },
    {
      slug: "surec-yonetimi",
      title: "Vekaletli idari yürütme",
      role: "Yoğun randevu / evrak / eşlik dönemleri — Stripe abonelik (noter idari vekaletiyle koordinasyon; otomatik yenileme).",
      href: "/hizmetler/surec-yonetimi",
    },
    {
      slug: "aylik-paket",
      title: "Aylık idari takip",
      role: "Sürekli gelen yazılar — Stripe abonelik (otomatik yenileme; yazı gelmese de dönem ücreti).",
  ...
  included: [
    ...
    "İstenirse fiziksel danışman eşliği (yerinde eşlik paketi veya kapsam notu)",
  ...
  engagementBody:
    "Yazınız varsa Başvur (tek yazı / aylık abonelik). Yerinde eşlik için Başvur → Yerinde eşlik (şehir zorunlu). Yoğun randevu: vekaletli abonelik. Telefon görüşmesi şu an sunulmuyor.",
  ctaConsult: "Yerinde eşlik — başvur",
  ctaConsultHref: "/basvuru?paket=yerinde-eslik",
  ctaPrimaryPackage: {
    label: "Yerinde eşlik — başvur",
    href: "/basvuru?paket=yerinde-eslik",
  },
  ctaSecondaryPackage: {
  ...
  disclaimer:
    "İdari koordinasyon, dil köprüsü ve istenirse yerinde eşlik hizmetidir. Kurum kararı, hesap, PESEL, ehliyet veya sağlık sonucu taahhüt edilmez. ROUTEPOL avukat veya mali müşavir değildir.",
};
...
export const eslikPl: ServiceDetailContent = {
  ...
  lead:
    "Samo streszczenie pisma bywa za mało: konto bankowe, PESEL, prawo jazdy, orzeczenie, wizyta w urzędzie. ROUTEPOL koordynuje te kroki; na życzenie konsultant towarzyszy fizycznie z mostem językowym PL.",
  positioning:
  ...
  workstreamsIntro:
    "Dosyaya göre değişir; wynik lub decyzja nie są gwarantowane. Przy sprawach intensywnych stosujemy prowadzenie z POA.",
  workstreams: [
    {
      title: "Linia firma",
  ...
  packagesIntro:
    "Pakiety pisemne oraz towarzyszenie na miejscu (pół dnia). Konsultacja telefoniczna nie jest obecnie dostępna. Intensywny okres — pakiet z POA.",
  packages: [
    {
      slug: "yerinde-eslik",
      title: "Towarzyszenie na miejscu (pół dnia)",
      role: "Urząd / bank / biuro — 1 wizyta, 450 zł baza; dojazd poza miastem osobno.",
      href: "/hizmetler/yerinde-eslik",
    },
    {
      slug: "surec-yonetimi",
      title: "Prowadzenie z POA",
      role: "Okres intensywny — abonament Stripe z POA (odnowienie automatyczne).",
      href: "/hizmetler/surec-yonetimi",
    },
    {
      slug: "aylik-paket",
      title: "Opieka miesięczna",
      role: "Regularne pisma — abonament Stripe (odnowienie automatyczne; opłata także bez pism).",
      href: "/hizmetler/aylik-paket",
    },
    {
      slug: "tek-yazi",
      title: "Jedno pismo",
      role: "Pojedyncze pismo — bez abonamentu.",
      href: "/hizmetler/tek-yazi",
    },
  ],
  ...
  engagementBody:
    "Macie pismo — wniosek (jedno pismo / miesięczny). Towarzyszenie na miejscu: wniosek → Towarzyszenie (miasto obowiązkowe). Intensywnie — POA. Konsultacja telefoniczna nie jest obecnie dostępna.",
  ctaConsult: "Towarzyszenie — wniosek",
  ctaConsultHref: "/basvuru?paket=yerinde-eslik",
  ctaPrimaryPackage: {
    label: "Towarzyszenie — wniosek",
    href: "/basvuru?paket=yerinde-eslik",
  },
  ctaSecondaryPackage: {
  ...
  disclaimer:
    "Koordynacja i język. Bez gwarancji decyzji urzędu. ROUTEPOL nie jest kancelarią.",
};
...
export const eslikEn: ServiceDetailContent = {
  ...
  lead:
    "A letter summary is not always enough: bank account, PESEL, licence change, medical certificate, office appointments. ROUTEPOL coordinates these steps; on request a consultant accompanies you in person with a Polish language bridge.",
  positioning:
    "We are not a law firm, bank or clinic. Decisions stay with the authority. ROUTEPOL: checklists, coordination, language — and optional on-site accompaniment.",
  ...
  workstreamsIntro:
    "Varies by file; outcomes are not guaranteed. For intensive work we use admin execution with POA.",
  workstreams: [
    {
      title: "Company track",
  ...
  packagesIntro:
    "Letter packages plus on-site accompaniment (half day). Phone consultation is not available right now. Heavy periods — POA package.",
  packages: [
    {
      slug: "yerinde-eslik",
      title: "On-site accompaniment (half day)",
      role: "Office / bank / urząd — 1 visit, 450 zł base; out-of-city travel separate.",
      href: "/hizmetler/yerinde-eslik",
    },
    {
      slug: "surec-yonetimi",
      title: "Admin execution with POA",
      role: "Intensive appointment / accompaniment periods — Stripe subscription (auto-renew).",
      href: "/hizmetler/surec-yonetimi",
    },
    {
      slug: "aylik-paket",
      title: "Monthly admin tracking",
      role: "Ongoing letters — Stripe subscription (auto-renew; fee even with no letters).",
      href: "/hizmetler/aylik-paket",
    },
    {
      slug: "tek-yazi",
      title: "Single letter",
      role: "One letter before/after accompaniment — no subscription.",
      href: "/hizmetler/tek-yazi",
    },
  ],
  ...
  engagementBody:
    "Have a letter — Apply (single letter / monthly). On-site: Apply → On-site accompaniment (city required). Heavy calendar — POA. Phone consultation is not currently sold.",
  ctaConsult: "On-site — apply",
  ctaConsultHref: "/basvuru?paket=yerinde-eslik",
  ctaPrimaryPackage: {
    label: "On-site — apply",
    href: "/basvuru?paket=yerinde-eslik",
  ...
  disclaimer:
    "Admin coordination and language only. No authority decision is promised. ROUTEPOL is not a law firm or tax office.",
};

...
export const kurulumTr: ServiceDetailContent = {
  ...
  workstreamsTitle: "Destek alanları",
  workstreamsIntro:
    "Yatırım ve kuruluş sürecinde sık görülen adımlar. Her kalemde bilgilendirme, koordinasyon ve pakete göre yazı özeti veya vekaletli idari yürütme sunulur. Karar ve imza yetkili mercide, avukatta veya muhasebecidedir.",
  workstreams: [
    {
  ...
  deliverables: [
    ...
    "Faz bazlı evrak ve adım checklist’i",
  ...
  packages: [
    {
      ...
      role: "Kuruluş ve yoğun dönem: noter idari vekaletiyle evrak/randevu koordinasyonu — Stripe abonelik (şirket tarifesi; otomatik yenileme).",
      href: "/hizmetler/surec-yonetimi",
    },
    {
      slug: "aylik-paket",
      title: "Aylık idari takip",
      role: "İlk yıl ve sonrası: Stripe abonelik (otomatik yenileme); kota, portal yükleme, aşım 40 zł; yazı gelmese de dönem ücreti; kota iadesi yok.",
      href: "/hizmetler/aylik-paket",
    },
    {
      slug: "tek-yazi",
      title: "Tek yazı",
      role: "Tek kritik kurum yazısı; taahhütsüz özet ve sonraki adım — abonelik yok.",
      href: "/hizmetler/tek-yazi",
    },
  ],
  includedTitle: "Kapsama giren",
  included: [
    "Polonya faaliyet açılışı ve ilk yıl için idari süreç haritası",
    ...
    "Banka hesabı açılışında idari fiili destek (KYC listesi, randevu, dil köprüsü / eşlik) — hesap açılışı veya kredi sonucu taahhüt edilmez",
  ...
  excluded: [
    ...
    "Banka hesabı açılışı veya kredi onayının garanti edilmesi",
  ...
  engagementBody:
    "İletişim formundan “TR işletmeci — Polonya yatırım / şirket kuruluşu” seçin. Hangi aşamada olduğunuzu yazın: karar öncesi, kuruluş, kayıt sonrası, sürekli faaliyet. Acil kurum yazısı varsa Tek yazı; düzenli yazı için Aylık abonelik (karttan otomatik yenilenir); yoğun idari dönem için Vekaletli abonelik. Telefon görüşmesi şu an sunulmuyor.",
  ctaConsult: "Yatırım / kuruluş görüşmesi",
  ctaPrimaryPackage: {
    label: "Vekaletli abonelik — başvur",
  ...
  disclaimer:
    "İdari köprü, dil özeti ve koordinasyon hizmetidir. Şirket kuruluşu, vergi, teşvik veya hukuki sonuç taahhüt edilmez. ROUTEPOL avukat veya mali müşavir değildir; karar yetkili mercilere ve sözleşmeli ortaklara aittir.",
};
...
export const kurulumPl: ServiceDetailContent = {
  ...
  lead:
    "Przedsiębiorcy działający w Turcji, którzy chcą założyć spółkę lub działalność w Polsce, potrzebują nie tylko adwokata: jasnej kolejności administracyjnej, przygotowania dokumentów centrali i uruchomienia ścieżki adwokat–notariusz–KRS. ROUTEPOL inicjuje ten proces: doradztwo, checklist, język, koordynacja.",
  positioning:
  ...
  workstreamsTitle: "Obszary wsparcia",
  workstreamsIntro:
  ...
  process: [
    ...
    {
      title: "3 · Realizacja",
      body: "Checklist + streszczenia; abonament z POA lub abonament miesięczny.",
    },
    {
      title: "4 · Raport",
  ...
  packages: [
    {
      ...
      role: "Rejestracja i okres intensywny — abonament Stripe z POA (taryfa firma; odnowienie automatyczne).",
      href: "/hizmetler/surec-yonetimi",
    },
    {
      slug: "aylik-paket",
      title: "Opieka miesięczna",
      role: "Pierwszy rok i dalej — abonament Stripe (odnowienie automatyczne); limit, portal, overage 40 zł; opłata także bez pism; limit bez zwrotu.",
      href: "/hizmetler/aylik-paket",
    },
    {
      slug: "tek-yazi",
  ...
  included: [
    "Mapa procesu uruchomienia i pierwszego roku",
    "Streszczenie pism i terminy",
    "Widoczność braków i koordynacja stron",
    "Most adwokat + księgowy",
    "Koordynacja z POA (pakiet)",
    "Wsparcie administracyjne przy otwarciu konta bankowego (lista KYC, wizyta, most językowy / towarzyszenie) — bez gwarancji otwarcia konta lub kredytu",
    "Status dla centrali",
  ...
  excluded: [
    ...
    "Gwarancja otwarcia konta bankowego lub kredytu",
  ...
  engagementBody:
    "Formularz — „Przedsiębiorca TR — inwestycja / założenie spółki w PL”. Podajcie fazę: przed decyzją, założenie, po wpisie, działalność bieżąca. Pilne pismo — Jedno pismo; regularne — abonament miesięczny (odnowienie kartą automatyczne); intensywny okres — abonament z POA. Konsultacja telefoniczna nie jest obecnie dostępna.",
  ctaConsult: "Rozmowa inwestycja / założenie",
  ctaPrimaryPackage: {
    label: "Abonament z POA — wniosek",
    href: "/basvuru?paket=surec-yonetimi",
  },
  ctaSecondaryPackage: {
  ...
  disclaimer:
    "Most administracyjny i językowy. Bez gwarancji założenia spółki, podatku ani wyniku prawnego. ROUTEPOL nie jest kancelarią ani biurem rachunkowym.",
};
...
export const kurulumEn: ServiceDetailContent = {
  ...
  lead:
    "Operators already running a business in Turkey who want a Polish company, branch or activity rarely need “just a lawyer”. They need a clear administrative sequence, HQ document preparation, and the lawyer–notary–KRS track started. ROUTEPOL initiates that process: advisory, checklists, language bridge and coordination.",
  positioning:
  ...
  workstreamsTitle: "Support areas",
  workstreamsIntro:
    "Common steps in investment and company formation. Each item covers guidance, coordination and — by package — letter summary or POA execution. Decisions stay with the authority, the lawyer or the accountant.",
  workstreams: [
    {
    ...
    },
    {
      ...
      items: [
        ...
        "KRS change sequences and lawyer bridge",
  ...
  deliverables: [
    ...
    "Phase-based document checklist",
  ...
  process: [
    ...
    {
      title: "3 · Delivery",
      body: "Checklists + summaries; POA subscription or Monthly subscription.",
    },
    {
      title: "4 · Reporting",
  ...
  packages: [
    {
      ...
      role: "Setup and intensive periods — Stripe subscription under admin POA (company rate; auto-renew).",
      href: "/hizmetler/surec-yonetimi",
    },
    {
      slug: "aylik-paket",
      title: "Monthly admin tracking",
      role: "First year and beyond — Stripe subscription (auto-renew); quota, portal uploads, 40 zł overage; fee even with no letters; unused quota not refunded.",
      href: "/hizmetler/aylik-paket",
    },
    {
      slug: "tek-yazi",
  ...
  included: [
    ...
    "Administrative support for bank-account opening (KYC list, appointment, language bridge / accompaniment) — no guarantee of account opening or credit approval",
    "HQ status summaries",
  ...
  excluded: [
    ...
    "Guaranteeing bank-account opening or credit approval",
  ...
  engagementBody:
    "Contact form — “TR operator — Poland investment / company formation”. State your phase: pre-decision, formation, post-registration, ongoing operations. Urgent letter — Single letter; regular letters — monthly subscription (card renews automatically); intensive admin — POA subscription. Phone consultation is not available right now.",
  ctaConsult: "Investment / formation meeting",
  ctaPrimaryPackage: {
    label: "POA subscription — apply",
    href: "/basvuru?paket=surec-yonetimi",
  },
  ctaSecondaryPackage: {
  ...
  disclaimer:
    "Admin bridge, language summary and coordination only. No incorporation, tax or legal outcome is promised. ROUTEPOL is not a law firm or tax office.",
};

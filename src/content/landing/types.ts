...
export type LandingNavChild = {
  id: string;
  label: string;
  /** Path after locale (`/hizmetler`) or hash (`#sss`) */
  href: string;
  /** Short Hostinger-style row hint */
  description?: string;
};
...
export type LandingNavItem = {
  id: string;
  label: string;
  /** Path after locale (`/hizmetler`) or hash (`#paketler`); parent may still link */
  href: string;
  /** Hostinger Products-style submenu */

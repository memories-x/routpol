...
export const landingPl: LandingContent = {
      ...
      children: [
        {
          ...
          href: "/hizmetler",
          description: "Hub — pakiety i ścieżki",
        },
        {
          id: "paketler-alt",
          label: "Pakiety",
          href: "/hizmetler#paketler",
          description: "Jedno pismo, miesięczny, POA, towarzyszenie",
        },
        {
          id: "eslik",
          label: "Towarzyszenie",
          href: "/hizmetler/eslik",
          description: "Urząd / bank / biuro — most językowy",
        },
        {
          id: "danismanlik",
          label: "Doradztwo handlowe",
          href: "/danismanlik",
          description: "Osobna linia — poza trackingiem",
        },
        {
          id: "kurulum",
          label: "Inwestycja / założenie",
          href: "/hizmetler/kurulum",
          description: "Przedsiębiorca TR — procesy w PL",
        },
        {
          id: "egitim",
          label: "Edukacja",
          href: "/hizmetler/egitim",
          description: "Uczelnia / guidance administracyjny",
        },
      ],
    },
  ...
  packages: {
    eyebrow: "Plany i ceny",
    title: "Pakiet dopasowany do potrzeby",
    intro:

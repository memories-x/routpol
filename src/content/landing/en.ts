...
export const landingEn: LandingContent = {
      ...
      children: [
        {
          ...
          label: "All services",
          href: "/hizmetler",
          description: "Hub — packages and lanes",
        },
        {
          id: "paketler-alt",
          label: "Packages",
          href: "/hizmetler#paketler",
          description: "Letter, monthly, POA, accompaniment",
        },
        {
          id: "eslik",
          label: "On-site accompaniment",
          href: "/hizmetler/eslik",
          description: "Office / bank / urząd language bridge",
        },
        {
          id: "danismanlik",
          label: "Trade advisory",
          href: "/danismanlik",
          description: "Separate lane — not admin tracking",
        },
        {
          id: "kurulum",
          label: "Investment / formation",
          href: "/hizmetler/kurulum",
          description: "TR operators — Poland processes",
        },
        {
          id: "egitim",
          label: "Education processes",
          href: "/hizmetler/egitim",
          description: "University / admin guidance",
        },
      ],
    },
  ...
  packages: {
    ...
    title: "The package that fits your need",
    intro:

/** ROUTEPOL Danışmanlık — kurumsal hizmet çerçevesi (ticaret masası). */
...
const tr: DanismanlikContent = {
  meta: {
    title: "ROUTEPOL Danışmanlık — Polonya ticaret danışmanlığı",
    description:
  ...
  pillarNote:
    "ROUTEPOL’un kamu yüzü idari evrak ve süreç takibidir. Bu sayfa ticaret danışmanlığı hizmet hattıdır; kapsamlar ayrı tutulur.",
...
const pl: DanismanlikContent = {
  meta: {
    title: "ROUTEPOL Doradztwo — doradztwo handlowe Polska",
    description:
  ...
  pillarNote:
    "Tracking administracyjny jest publiczną twarzą ROUTEPOL. Ta strona to linia doradztwa handlowego; zakresy są rozdzielone.",
...
const en: DanismanlikContent = {
  meta: {
    title: "ROUTEPOL Advisory — Poland trade advisory",
    description:
  ...
  pillarNote:
    "Admin paperwork tracking is ROUTEPOL’s public face. This page is the trade-advisory service line; scopes are kept separate.",

...
export const educationTr: EducationContent = {
  ...
  positioning:
    "POL-TURK bir eğitim danışmanlığı ajansı veya aracı kurum değildir; öğrenci yerleştirmeyiz, kontenjan satmayız. Ürünümüz: süreç şeffaflığı, evrak netliği ve resmi yazıların PL / EN / TR açıklaması — aile, öğrenci adayı, eğitim kurumu ve işveren (çalışan eğitimi) için aynı kurumsal standart.",
  ...
  pillars: [
    {
      title: "Süreç haritası (bilgilendirme)",
  ...
  deliverables: [
    ...
    "Evrak checklist’i (kaynak: kurum talebi / genel bilgilendirme)",
  ...
  process: [
    ...
    },
    {
      ...
      body: "Sonuç özeti teslimi veya aylık dönemde yeni yazıların takibi. Yeni dönem ayrıca yenilenir.",
    },
  ],
  ...
  engagementBody:
    "Eğitim yönlendirmesi için önce kısa görüşme formu. Elinizde kurum yazısı varsa doğrudan Tek yazı veya Aylık takip ile başlayabilirsiniz. Vekaletli idari yürütme, noter idari vekaleti gerektiren randevu / evrak koordinasyonu içindir.",
  ctaConsult: "Eğitim yönlendirme görüşmesi",
  ctaLetter: "Elimde yazı var — başvur",
  ctaBack: "Tüm hizmetlere dön",
  disclaimer:
    "Bu hizmet bilgilendirme ve idari koordinasyon amaçlıdır. Üniversite, devlet kurumu veya konsolosluk kararlarını taahhüt etmez. POL-TURK avukat veya eğitim aracısı değildir.",
};
...
export const educationPl: EducationContent = {
  ...
  eyebrow: "Edukacja · most administracyjny",
  title: "Guidance procesu edukacyjnego i uniwersyteckiego",
  lead:
  ...
  positioning:
    "POL-TURK nie jest agencją edukacyjną ani pośrednikiem rekrutacyjnym — nie lokujemy studentów i nie sprzedajemy miejsc. Produkt: przejrzystość procesu, checklist dokumentów i streszczenia pism PL / EN / TR.",
  whoTitle: "Dla kogo?",
  who: [
    {
  ...
  pillars: [
    {
      title: "Mapa procesu (informacyjnie)",
  ...
  process: [
    ...
    },
    {
      ...
      body: "Wynik lub tracking w okresie miesięcznym.",
    },
  ],
  ...
  engagementBody:
    "Najpierw krótki formularz konsultacji. Macie pismo uczelni — Jedno pismo lub pakiet miesięczny. POA — osobny pakiet.",
  ctaConsult: "Konsultacja edukacyjna",
  ctaLetter: "Mam pismo — złóż wniosek",
  ctaBack: "Wróć do usług",
  disclaimer:
    "Usługa informacyjna i koordynacyjna. Nie gwarantuje decyzji uczelni ani urzędu. POL-TURK nie jest kancelarią ani agencją edukacyjną.",
};
...
export const educationEn: EducationContent = {
  ...
  positioning:
    "POL-TURK is not an education agency or placement intermediary — we do not place students or sell seats. Our product is process clarity, document checklists and official-letter summaries in PL / EN / TR.",
  ...
  pillars: [
    {
      title: "Process map (informational)",
  ...
  process: [
    ...
    },
    {
      ...
      body: "Result handoff or ongoing tracking in a monthly period.",
    },
  ],
  ...
  engagementBody:
    "Start with a short consultation form. If you already hold an institutional letter, use Single letter or Monthly tracking. POA coordination is a separate package.",
  ctaConsult: "Request education consult",
  ctaLetter: "I have a letter — apply",
  ctaBack: "Back to all services",
  disclaimer:
    "Informational and coordination service only. No university or government decision is promised. POL-TURK is not a law firm or education agency.",
};

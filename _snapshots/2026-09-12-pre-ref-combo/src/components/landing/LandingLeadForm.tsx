...
export function LandingLeadForm({ content, locale }: Props) {
  ...
  return (
    <section id="iletisim" className="scroll-mt-20 bg-pt-emerald-50/35 py-16 md:py-24">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-14">
        ...
        <div className="rounded-2xl border border-pt-border bg-pt-surface p-6 shadow-[0_16px_40px_-28px_rgba(15,23,42,0.35)] md:p-8">
          {form}
        </div>
      </div>
    </section>

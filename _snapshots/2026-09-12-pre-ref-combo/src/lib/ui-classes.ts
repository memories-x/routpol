/** Wise-inspired shared classes — Quiet Authority tokens. */
...
export function packageCardClassName(featured: boolean): string {
  return featured
    ? "relative flex h-full flex-col overflow-hidden rounded-2xl border-2 border-pt-emerald-600 bg-pt-surface p-6 shadow-[0_16px_40px_-28px_rgba(5,150,105,0.45)]"
    : "flex h-full flex-col rounded-2xl border border-pt-border bg-pt-surface p-6 shadow-[0_12px_32px_-24px_rgba(15,23,42,0.3)]";
}

...
- Müşteri: e-posta + şifre üyelik (`/hesabim`); magic link = şifre sıfırlama · Panel: parola cookie
...
Kamu site / landing görseli: `.cursor/skills/public-visual-qa/SKILL.md`  
Zorunlu: Browser QA · tek yüzey · referans · snapshot (`quiet authority baseline'a dön`)

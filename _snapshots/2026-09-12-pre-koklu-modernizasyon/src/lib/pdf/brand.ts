/** POL-TURK chrome for deliverable PDFs — same tokens as pdf-cevirmen / public/brand. */

export const BRAND_NAME = "POL-TURK";
...
const BANNER: Record<BrandLang, string> = {
  tr: "POL-TURK  ·  BELGE CEVIRISI",
  pl: "POL-TURK  ·  TLUMACZENIE DOKUMENTU",
  en: "POL-TURK  ·  DOCUMENT TRANSLATION",
};

const FOOT: Record<BrandLang, string> = {
  tr: "POL-TURK  ·  kurumsal duzen  ·  yeminli tercume degildir",
  pl: "POL-TURK  ·  szablon firmowy  ·  nie jest tlumaczeniem przysieglym",
  en: "POL-TURK  ·  corporate layout  ·  not a sworn translation",
};

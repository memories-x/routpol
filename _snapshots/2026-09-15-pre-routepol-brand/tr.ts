...
export const landingTr: LandingContent = {
  meta: {
    ...
    description:
      "Türkiye’de yerleşik işletmeciler ile Polonya’da faaliyet gösteren Türk ve yabancı sermayeli şirketler için resmi yazı, evrak ve idari süreç takibi. Dilinizde özet. Net adım. Ayrıca ticaret danışmanlığı.",
  },
  brand: {
    name: "POL-TURK",

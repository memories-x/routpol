...
const hubTr: RehberHub = {
  meta: {
    title: "Rehber — Polonya idari süreçler (bilgilendirme)",
    description:
  ...
  disclaimer:
    "Bu sayfalar genel bilgilendirmedir. Karar mercilere ve yetkili kişilere aittir. POL-TURK avukat veya mali müşavir değildir.",
  cards: [
    {
      slug: "kurum-yazisi",
...
const articlesTr: RehberArticle[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "2) Anlamak",
        paragraphs: [
          "Lehçe resmi dil çoğu zaman net değildir. POL-TURK yazıyı PL / EN / TR özetler: ne istendi, son tarih, kim ne yapmalı (siz, muhasebe, avukat ortağı).",
      ...
      },
      {
        ...
        title: "3) Hangi ürün?",
        paragraphs: [
          "Tek kritik yazı ve taahhütsüz giriş için Tek yazı. Ay boyunca birden fazla yazı geliyorsa Aylık idari takip. Yoğun randevu / evrak koordinasyonu ve noter idari vekaleti gerekiyorsa Vekaletli idari yürütme.",
        ],
      },
      {
        id: "sonra",
  ...
  },
  {
    ...
    title: "Hangi paketi seçmeliyim?",
    description:
      "Üç paket: Tek yazı, Aylık takip, Vekaletli yürütme. Kısa karar ağacı.",
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Aylık idari takip — dönem kotası, portalda ek yazı, aşım 40 zł / yazı.",
          "Vekaletli idari yürütme — noter idari vekaletiyle evrak/randevu koordinasyonu (hukuki temsil değil).",
        ],
      },
      {
        id: "sec",
        ...
        paragraphs: [
          ...
          "Her ay düzenli yazı geliyorsa (US/ZUS/KRS): Aylık takip.",
          "Kuruluş dönemi veya yoğun urzęd/noter koordinasyonu: Vekaletli paket + gerekirse avukat ortağı (ücreti ayrı).",
        ],
      },
      {
        id: "degil",
  ...
  },
  {
    ...
    disclaimer:
      "Genel çerçeve. Yapı seçimi, sözleşme ve KRS kararı avukat ortağındadır. POL-TURK şirketi sizin adınıza kurmaz.",
    sections: [
      {
        id: "sira",
        title: "Tipik idari sıra (bilgilendirme)",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "POL-TURK: süreç haritası, eksik evrak görünürlüğü, dil köprüsü, dosyayı ortağa iletme, kayıt sonrası yazı özeti.",
  ...
  {
    slug: "sahis-idari",
    title: "Şahıs — urzęd, ehliyet, oturum kartı",
    description:
  ...
  },
  {
    ...
    title: "MOS nedir?",
    description:
      "Bazı oturum başvurularının elektronik yapıldığı resmi portal. POL-TURK oturum çıkarmaz.",
    eyebrow: "Rehber · MOS",
    disclaimer:
    ...
    sections: [
      ...
      {
        id: "biz",
        title: "2) POL-TURK ne yapar / yapmaz?",
        paragraphs: [
          "Yapar: MOS veya urzędden gelen yazıyı dilinizde açıklar; ne istendi, son tarih, kim ne yapacak; süreç durumunu takip eder (pakete göre).",
...
const hubPl: RehberHub = {
  meta: {
    title: "Przewodnik — administracja w PL (informacyjnie)",
    description:
  ...
  disclaimer:
    "Treści ogólne. Decyzje należą do urzędów i osób uprawnionych. POL-TURK nie jest kancelarią ani biurem rachunkowym.",
  cards: [
    {
      slug: "kurum-yazisi",
...
const articlesPl: RehberArticle[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "2) Zrozumienie",
        paragraphs: [
          "POL-TURK streści pismo PL / EN / TR: czego żądają, termin, kto działa. Nie podejmujemy decyzji za urząd i nie składamy wniosku w Państwa imieniu.",
        ],
      },
      {
        id: "paket",
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Opieka miesięczna — limit okresu, portal; nadwyżka 40 zł.",
          "Prowadzenie z POA — koordynacja administracyjna (nie reprezentacja prawna).",
        ],
      },
      {
        id: "sec",
        ...
        paragraphs: [
          ...
          "Regularne pisma → opieka miesięczna.",
          "Rejestracja / intensywna koordynacja → POA (+ adwokat osobno).",
        ],
      },
      {
        id: "degil",
  ...
  },
  {
    ...
    sections: [
      {
        id: "sira",
        title: "Typowa kolejność (informacyjnie)",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "POL-TURK: mapa procesu, braki, język, przekazanie teczki, streszczenia po rejestracji.",
      ...
      },
      {
        ...
        title: "Jak zacząć?",
        paragraphs: [
          "`/hizmetler/kurulum` oraz formularz „Przedsiębiorca TR — inwestycja”. Intensywnie — POA; regularne pisma — pakiet miesięczny.",
        ],
      },
    ],
    ctaPrimary: {
  ...
  },
  {
    ...
    title: "Czym jest MOS?",
    description:
      "Portal elektronicznych wniosków o pobyt. POL-TURK nie załatwia pobytu.",
...
const hubEn: RehberHub = {
  meta: {
    title: "Guides — Poland admin processes (informational)",
    description:
  ...
  disclaimer:
    "General information only. Decisions stay with authorities and authorised persons. POL-TURK is not a law firm or tax office.",
  cards: [
    {
      slug: "kurum-yazisi",
...
const articlesEn: RehberArticle[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "POL-TURK summarises the letter in PL / EN / TR: what is asked, deadline, who acts. We do not decide for the office or file on your behalf.",
        ],
      },
      {
        id: "paket",
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Monthly admin tracking — period quota, portal; 40 zł per extra letter.",
          "Admin execution with POA — admin coordination (not legal representation).",
        ],
      },
      {
        id: "sec",
        ...
        paragraphs: [
          ...
          "Regular letters → Monthly tracking.",
          "Formation / heavy coordination → POA (+ lawyer separately).",
        ],
      },
      {
        id: "degil",
  ...
  },
  {
    ...
    sections: [
      {
        id: "sira",
        title: "Typical sequence (informational)",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "POL-TURK: process map, gaps, language, handoff, post-registration summaries.",
  ...
  },
  {
    ...
    title: "What is MOS?",
    description:
      "Official portal for some residence filings. POL-TURK does not obtain residence.",
    eyebrow: "Guide · MOS",
    disclaimer:

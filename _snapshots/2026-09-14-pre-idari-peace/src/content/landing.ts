...
export const landingTr: LandingContent = {
  meta: {
    title: "POL-TURK | Polonya ticaret danışmanlığı — pazar, karşı taraf, görüşme",
    description:
      "Polonya pazar girişinde ticaret danışmanlığı: görünürlük, karşı taraf, görüşme ve teklif derlemesi. Aynı çatıda idari yazı paketleri. TR / PL / EN.",
  },
  brand: {
    name: "POL-TURK",
    tagline: "Polonya pazar girişinde ticaret danışmanlığı",
    secondName: "POL-TURK Danışmanlık",
    secondLineHint: "ticaret danışmanlığı · ana iş kolu",
  },
  nav: [
  ...
  accountLink: "Giriş",
  hero: {
    eyebrow: "Polonya · ticaret danışmanlığı",
    title: "Polonya pazarında yapılandırılmış giriş",
    subtitle:
      "Pazar görünürlüğü, karşı taraf haritası, ticari görüşme ve teklif derlemesi. Aynı çatıda idari yazı ve takip paketleri.",
    valueLine:
      "Danışmanlık kalem bazlı yazılı teklifle yürür. Taşıma ve gümrük lisanslı partnerler üzerinden; tescil ve hukuki temsil avukat ortağındadır.",
    ctaPrimary: "Danışmanlık",
    ctaPrimaryHref: "/danismanlik",
    ctaSecondary: "İdari paketler",
    ctaSecondaryHref: "/hizmetler#paketler",
    supportTrack: {
      kicker: "Operasyon · Stripe paketleri",
      title: "İdari köprü — yazı özeti ve takip",
      body: "Kurum yazısı, aylık takip, vekaletli yürütme ve yerinde eşlik. Ticaret danışmanlığından ayrı ürün hattı.",
      ctaLabel: "Paketlere git",
  ...
  lead: {
    ...
    intro:
      "Ticaret danışmanlığı veya idari paket sorusu: bu form. Acil yazı: üst menüden Başvur. Dönüş genelde 1 iş günü.",
    fullName: "Ad Soyad",
...
export const landingPl: LandingContent = {
  ...landingTr,
  meta: {
    title: "POL-TURK | Doradztwo handlowe Polska",
    description:
      "Wejście na rynek PL: widoczność, kontrahenci, spotkania i oferty. Pod tym samym dachem pakiety administracyjne. TR / PL / EN.",
  },
  brand: {
    name: "POL-TURK",
    tagline: "Most przy wejściu handlowym do Polski",
    secondName: "POL-TURK Doradztwo",
    secondLineHint: "biurko handlowe · główna linia",
  },
  nav: [
  ...
  hero: {
    eyebrow: "Polska · doradztwo handlowe",
    title: "Uporządkowane wejście na rynek polski",
    subtitle:
      "Widoczność rynku, mapa kontrahentów, spotkania handlowe i zestawienie ofert. Pod tym samym dachem pakiety administracyjne.",
    valueLine:
      "Doradztwo według otwartych pozycji w ofercie pisemnej. Transport i cło przez licencjonowanych partnerów; wpis i reprezentacja u adwokata-partnera.",
    ctaPrimary: "Doradztwo",
    ctaPrimaryHref: "/danismanlik",
    ctaSecondary: "Pakiety administracyjne",
    ctaSecondaryHref: "/hizmetler#paketler",
    supportTrack: {
      kicker: "Operacje · pakiety Stripe",
      title: "Most administracyjny — streszczenia i tracking",
      body: "Pisma urzędowe, opieka miesięczna, POA i towarzyszenie. Osobna linia od doradztwa handlowego.",
      ctaLabel: "Do pakietów",
      href: "/hizmetler#paketler",
    },
    demo: {
  ...
  lead: {
    ...
    intro:
      "Biurko handlowe lub pakiet administracyjny: ten formularz. Pilne pismo: menu «Złóż wniosek». Odpowiedź zwykle 1 dzień.",
...
export const landingEn: LandingContent = {
  ...landingTr,
  meta: {
    title: "POL-TURK | Poland trade advisory",
    description:
      "Poland market entry advisory: visibility, counterparties, meetings and quotes. Under the same roof: admin letter packages. TR / PL / EN.",
  },
  brand: {
    name: "POL-TURK",
    tagline: "Your bridge into the Polish market",
    secondName: "POL-TURK Advisory",
    secondLineHint: "trade desk · primary line",
  },
  nav: [
  ...
  accountLink: "Sign in",
  hero: {
    eyebrow: "Poland · trade advisory",
    title: "Structured entry into the Polish market",
    subtitle:
      "Market visibility, counterparty mapping, commercial meetings and quote compilation. Under the same roof: administrative letter packages.",
    valueLine:
      "Advisory is scoped by service line in a written proposal. Transport and customs run through licensed partners; registration and legal representation stay with the lawyer partner.",
    ctaPrimary: "Advisory",
    ctaPrimaryHref: "/danismanlik",
    ctaSecondary: "Admin packages",
    ctaSecondaryHref: "/hizmetler#paketler",
    supportTrack: {
      kicker: "Operations · Stripe packages",
      title: "Admin bridge — letter summaries and tracking",
      body: "Official letters, monthly tracking, POA and on-site accompaniment. A product line separate from trade advisory.",
      ctaLabel: "Go to packages",
      href: "/hizmetler#paketler",
    },
    demo: {
  ...
  lead: {
    title: "Short contact",
    intro:
      "Trade desk or admin package question: this form. Urgent letter: header Apply. Reply usually in 1 business day.",
    fullName: "Full name",

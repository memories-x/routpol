...
export function LandingHero({ content, locale }: Props) {
  ...
  const secondTrack = content.hero.secondTrack;
  const secondTrackHref = secondTrack
    ? resolveHref(locale, secondTrack.href)
    : "";
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-14 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:py-28">
        <div className="pt-hero-copy">
          ...
          {secondTrack ? (
            <aside
              id="ticaret"
              className="mt-8 max-w-md scroll-mt-24 rounded-2xl border border-dashed border-pt-border bg-pt-surface/80 px-4 py-4"
            >

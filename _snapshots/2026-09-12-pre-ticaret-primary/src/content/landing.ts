...
export const landingTr: LandingContent = {
  ...
  brand: {
    ...
    secondLineHint: "ikinci hat (yazı paketlerinden ayrı)",
  },
  nav: [
  ...
  packages: {
    ...
    intro:
      "Dört paket: Tek yazı, Aylık takip, Vekaletli yürütme, Yerinde eşlik. Ödeme sonrası dosya açılır.",
    applyLabel: "Başvur",
    detailLabel: "Detay",
    featuredStory: {
      title: "Ay boyunca",
...
export const landingPl: LandingContent = {
  ...
  brand: {
    ...
    secondLineHint: "druga linia (osobno od pakietów pism)",
  },
  nav: [
  ...
  packages: {
    ...
    intro:
      "Cztery pakiety: Jedno pismo, Opieka miesięczna, Prowadzenie z POA, Towarzyszenie na miejscu. Po płatności otwiera się sprawa.",
...
export const landingEn: LandingContent = {
  ...
  brand: {
    ...
    secondLineHint: "second line (separate from letter packages)",
  },
  nav: [
  ...
  packages: {
    ...
    intro:
      "Four packages: Single letter, Monthly tracking, POA execution, On-site accompaniment. A case opens after payment.",
    applyLabel: "Apply",
    detailLabel: "Details",
    featuredStory: {

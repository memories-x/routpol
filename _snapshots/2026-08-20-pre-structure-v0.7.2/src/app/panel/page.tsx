...
export default async function PanelHomePage() {
  ...
  const [stats, customers, cases, activePeriods] = await Promise.all([
    getPanelStats(),
    listCustomerSummaries(),
    listPanelCases(),
  ...
  return (
    <div>
      ...
      <PageHeader
        ...
        description="Günlük: kuyruk → işle → sonuç yükle. Aylık kota müşteride (/hesabim). Ay sonu: Faturalar → ZIP → muhasebeci."
        actions={
          <>
            <a

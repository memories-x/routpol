  ...
  return (
    <section id="iletisim" className="scroll-mt-20 bg-pt-surface py-16 md:py-24">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 lg:grid-cols-2">
        <div>
          <SectionIntro title={content.contact.title} />
          <p className="mt-6 rounded-lg border border-pt-emerald-600/25 bg-pt-emerald-50/50 px-4 py-3 text-sm text-pt-navy-900">
          ...
          <dl className="mt-8 space-y-4 text-sm text-pt-slate-600">
            <div>
              <dt className="font-semibold text-pt-navy-900">

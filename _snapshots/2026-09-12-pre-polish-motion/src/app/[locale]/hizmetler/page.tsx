              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    {item.badge ? (
                      <p className="rounded-lg bg-pt-emerald-50 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wide text-pt-emerald-700">
                        {item.badge}
                      </p>
                    ) : null}
                  </div>
                  ...
                  <p className="mt-5 text-sm font-semibold text-pt-navy-950">
                    {item.priceFrom}
                  </p>
                  <div className="mt-5 flex flex-col gap-2 border-t border-pt-border pt-5">
                    <Link
                      href={`/${locale}/basvuru?paket=${item.slug}`}
                      className={`${btnPrimaryClassName} w-full text-center`}
                    >

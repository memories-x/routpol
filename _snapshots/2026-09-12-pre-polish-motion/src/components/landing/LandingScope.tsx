...
/**
 * Revolut Business cue (controlled): single navy cross-border band.
 * Not sitewide noise — honesty + PL→TR corridor only.
 */
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-wrap items-end justify-between gap-6">
          ...
          <div
            className="inline-flex items-center gap-3 rounded-full border border-white/15 bg-white/5 px-4 py-2 font-mono text-xs font-semibold tracking-wide text-pt-emerald-300"
            aria-hidden
          >
            <span>PL</span>
            <span className="h-px w-8 bg-pt-emerald-400/70" />
            <span>TR</span>
          </div>
        </div>

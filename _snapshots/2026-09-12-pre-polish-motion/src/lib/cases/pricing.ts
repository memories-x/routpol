...
export function productNameFor(
  ...
  if (slug === "telefon-gorusme") {
    if (locale === "pl") return "POL-TURK — Konsultacja telefoniczna (1 godz.)";
    if (locale === "en") return "POL-TURK — Phone consultation (1 hour)";
    return "POL-TURK — Telefon görüşmesi (1 saat)";
  }

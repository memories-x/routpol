...
/** Display order for public package grids (3 SKUs). */
...
/** Customer must upload mektup before pay (telefon: evrak isteğe bağlı) */
export function packageRequiresDocumentUploads(slug: string): boolean {
  return isLetterPackage(slug) && slug !== "telefon-gorusme";
}

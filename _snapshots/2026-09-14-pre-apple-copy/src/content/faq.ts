  ...
  items: [
    {
      ...
      answer:
        "Türkiye’deki girişimci ve şirketlerin Polonya tarafındaki evrak işleri ile idari süreçlerini takip ederiz. Kurum yazısını dilinizde açıklarız; ne istendi, son tarih ve sıradaki adımı net tutarız. Hukuki süreç avukat ortağındadır — biz köprü ve takipiz.",
    },
    {
      id: "kim",
      question: "Kimler için?",
      answer:
        "Türkiye’den Polonya’da işi veya şirketi olan girişimciler ve firmalar; Polonya’daki yabancı şirketler ve şahıslar. Resmi yazı veya idari süreçte net takip isteyenler.",
    },
    {
      id: "dil",
  ...
  items: [
    {
      ...
      question: "Co robicie?",
      answer:
        "Śledzimy dokumenty i procesy administracyjne firm z Turcji po stronie Polski. Wyjaśniamy pisma urzędowe w Waszym języku: czego chcą, jaki termin, co dalej. Proces prawny zostaje u adwokata-partnera — my jesteśmy mostem i trackingiem.",
    },
    {
      id: "kim",
      question: "Dla kogo?",
      answer:
        "Przedsiębiorcy i firmy z Turcji z sprawami w PL; firmy zagraniczne w Polsce i osoby prywatne. Kto chce jasnego śledzenia spraw administracyjnych.",
    },
    {
      id: "dil",
  ...
  items: [
    {
      ...
      answer:
        "We track Poland-side paperwork and administrative processes for Turkish entrepreneurs and companies. We explain official letters in your language: what is asked, the deadline, the next step. Legal process stays with the lawyer partner — we are the bridge and the tracking.",
    },
    {
      id: "kim",
      question: "Who is this for?",
      answer:
        "Entrepreneurs and companies from Turkey with Poland-side work; foreign companies in Poland and individuals who need clear admin tracking.",
    },
    {
      id: "dil",

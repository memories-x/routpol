...
export const landingTr: LandingContent = {
  meta: {
    title: "POL-TURK | Polonya’da evrak ve idari takip — Türkiye’den güvenle",
    description:
      "Türkiye’deki girişimci ve şirketler için Polonya tarafında resmi yazı, evrak ve idari süreç takibi. Dilinizde özet, net adım, dosya takibi. Aynı çatıda ticaret danışmanlığı.",
  },
  brand: {
    name: "POL-TURK",
    tagline: "Polonya’da evrak ve idari takip — Türkiye’den",
    secondName: "POL-TURK",
    secondLineHint: "idari köprü · kafanız rahat",
  },
  nav: [
  ...
  accountLink: "Giriş",
  hero: {
    eyebrow: "Türkiye → Polonya · idari köprü",
    title: "Polonya tarafını bize bırakın",
    subtitle:
      "Türkiye’deki girişimci ve şirketlerin Polonya’daki evrak işleri ile idari süreçlerini takip ederiz. Yazı gelir, özetlenir, adım netleşir — siz karar verirsiniz.",
    valueLine:
      "Amaç: Polonya idaresini güvenle teslim etmek. Avukat değiliz; tescil ve hukuki temsil avukat ortağındadır. Aynı çatıda ticaret danışmanlığı ayrı hattır.",
    ctaPrimary: "İdari paketler",
    ctaPrimaryHref: "/hizmetler#paketler",
    ctaSecondary: "Ticaret danışmanlığı",
    ctaSecondaryHref: "/danismanlik",
    supportTrack: {
      kicker: "Aynı çatı · danışmanlık",
      title: "Ticaret danışmanlığı — pazar ve teklif hattı",
      body: "Pazar görünürlüğü, karşı taraf, görüşme ve teklif derlemesi. İdari takip paketlerinden ayrı ürün.",
      ctaLabel: "Danışmanlığa git",
      href: "/danismanlik",
    },
    demo: {
  ...
  bridge: {
    ...
    title: "Polonya idaresi sizde kaybolmaz",
    intro:
      "Türkiye’den Polonya tarafını bize bırakırsınız: kurum yazar, biz dilinizde açıklar ve takip ederiz, karar sizde kalır.",
    lanes: [
      {
        id: "kurum",
        label: "Kurum",
      ...
      },
      {
        id: "siz",
        label: "Siz",
        body: "Kapsamı onaylar, belgeyi sağlarsınız; karar ve imza sizde veya yetkili ortağınızda kalır — kafa dağınık olmaz.",
      },
    ],
    lawyerNote:
  ...
  scope: {
    ...
    included: [
      "Türkiye’deki girişimci / şirket için Polonya tarafında evrak ve idari süreç takibi",
  ...
  lead: {
    ...
    intro:
      "Polonya’daki evrak / idari takip veya paket sorusu: bu form. Acil yazı: üst menüden Başvur. Dönüş genelde 1 iş günü.",
    fullName: "Ad Soyad",
...
export const landingPl: LandingContent = {
  ...landingTr,
  meta: {
    title: "POL-TURK | Tracking administracyjny PL — z Turcji spokojnie",
    description:
      "Dla przedsiębiorców i firm z Turcji: pisma, dokumenty i procesy administracyjne po stronie Polski — śledzenie i jasne kroki. Pod tym samym dachem doradztwo handlowe.",
  },
  brand: {
    name: "POL-TURK",
    tagline: "Administracja i dokumenty w PL — z Turcji",
    secondName: "POL-TURK",
    secondLineHint: "most administracyjny · spokojna głowa",
  },
  nav: [
  ...
  hero: {
    eyebrow: "Turcja → Polska · most administracyjny",
    title: "Stronę polską zostawcie nam",
    subtitle:
      "Śledzimy dokumenty i procesy administracyjne firm z Turcji po stronie PL. Pismo przychodzi, streszczamy, krok jest jasny — decyzja należy do Państwa.",
    valueLine:
      "Cel: spokojnie przekazać administrację PL. Nie jesteśmy kancelarią; wpis i reprezentacja u adwokata-partnera. Doradztwo handlowe — osobna linia pod tym samym dachem.",
    ctaPrimary: "Pakiety administracyjne",
    ctaPrimaryHref: "/hizmetler#paketler",
    ctaSecondary: "Doradztwo handlowe",
    ctaSecondaryHref: "/danismanlik",
    supportTrack: {
      kicker: "Pod tym samym dachem · doradztwo",
      title: "Doradztwo handlowe — rynek i oferty",
      body: "Widoczność rynku, kontrahenci, spotkania i zestawienie ofert. Osobna linia od pakietów administracyjnych.",
      ctaLabel: "Do doradztwa",
      href: "/danismanlik",
    },
    demo: {
  ...
  bridge: {
    eyebrow: "Co robimy",
    title: "Administracja PL nie ginie u Państwa",
    intro:
      "Z Turcji zostawiacie nam stronę polską: instytucja pisze, my wyjaśniamy i śledzimy, decyzja należy do Państwa.",
    lanes: [
      {
        id: "kurum",
        label: "Instytucja",
      ...
      },
      {
        id: "siz",
        label: "Państwo",
        body: "Zatwierdzacie zakres, dostarczacie dokumenty; decyzja i podpis zostają u Was — bez chaosu w głowie.",
      },
    ],
    lawyerNote:
  ...
  lead: {
    ...
    intro:
      "Sprawy dokumentów / trackingu PL lub pakiet: ten formularz. Pilne pismo: menu «Złóż wniosek». Odpowiedź zwykle 1 dzień.",
...
export const landingEn: LandingContent = {
  ...landingTr,
  meta: {
    title: "POL-TURK | Poland admin & paperwork tracking — from Turkey",
    description:
      "For Turkish entrepreneurs and companies: Poland-side official letters, documents and admin process tracking. Clear next steps. Under the same roof: trade advisory.",
  },
  brand: {
    name: "POL-TURK",
    tagline: "Poland admin & paperwork tracking — from Turkey",
    secondName: "POL-TURK",
    secondLineHint: "admin bridge · peace of mind",
  },
  nav: [
  ...
  accountLink: "Sign in",
  hero: {
    eyebrow: "Turkey → Poland · admin bridge",
    title: "Leave the Poland side with us",
    subtitle:
      "We track paperwork and administrative processes in Poland for Turkish entrepreneurs and companies. Letters arrive, we summarise, the next step is clear — decisions stay yours.",
    valueLine:
      "Goal: hand over Poland-side admin with peace of mind. We are not a law firm; registration and legal representation stay with the lawyer partner. Trade advisory is a separate line under the same roof.",
    ctaPrimary: "Admin packages",
    ctaPrimaryHref: "/hizmetler#paketler",
    ctaSecondary: "Trade advisory",
    ctaSecondaryHref: "/danismanlik",
    supportTrack: {
      kicker: "Same roof · advisory",
      title: "Trade advisory — market and quotes",
      body: "Market visibility, counterparties, meetings and quote compilation. Separate from admin tracking packages.",
      ctaLabel: "Go to advisory",
      href: "/danismanlik",
    },
    demo: {
  ...
  bridge: {
    eyebrow: "What we do",
    title: "Poland-side admin does not get lost",
    intro:
      "From Turkey, you leave the Poland side with us: the authority writes, we explain and track, decisions stay yours.",
    lanes: [
      {
        id: "kurum",
        label: "Authority",
      ...
      },
      {
        id: "siz",
        label: "You",
        body: "You approve scope and supply documents; decisions and signatures stay with you — without mental clutter.",
      },
    ],
    lawyerNote:
  ...
  lead: {
    title: "Short contact",
    intro:
      "Poland paperwork / admin tracking or package question: this form. Urgent letter: header Apply. Reply usually in 1 business day.",
    fullName: "Full name",

/** POL-TURK kamu landing — idari köprü (kanon). BPO denemesi kaldırıldı. */
...
export type LandingContent = {
  ...
  brand: { name: string; tagline: string; secondName?: string };
  nav: LandingNavItem[];
  headerCta: string;
  accountLink: string;
  hero: {
    ...
    /**
     * İkinci hat (çekirdek dışı) — eşit CTA değil; ticaret / danışmanlık notu.
     * İlk etap gelir: yazı paketleri.
     */
    secondTrack?: {
      kicker: string;
      title: string;
    ...
    demo: {
      label: string;
      footnote: string;
      /** Pitch/Clerk status chip while rows reveal */
...
export const landingTr: LandingContent = {
  meta: {
    title: "POL-TURK | Polonya idari köprü — yatırım, kuruluş, takip",
    description:
      "Türkiye merkezli işletmecilerin Polonya’daki yatırım, şirket kuruluşu ve faaliyet süreçlerinde idari danışmanlık. KOBİ, şahıs ve urzęd takibi. TR / PL / EN / RU / UK. Avukat değiliz.",
  },
  brand: {
    name: "POL-TURK",
    tagline: "Resmi yazıyı anlatırız, süreci takip ederiz",
    secondName: "POL-TURK Danışmanlık",
  },
  nav: [
  ...
  accountLink: "Giriş",
  hero: {
    eyebrow: "Polonya · kurumsal idari danışmanlık",
    title: "Polonya’daki resmi süreçleriniz tek masada",
    subtitle:
      "Yatırım, şirket kuruluşu ve urzęd yazışmalarında dil köprüsü, takip ve avukat ortağına koordinasyon. TR / PL / EN.",
    valueLine:
      "Avukat, mali müşavir veya yeminli tercüman değiliz. Tescil ve hukuki temsil Polonyalı avukat ortağındadır; biz idari danışmanlık ve süreç takibi sağlarız.",
    ctaPrimary: "Paketler",
    ctaPrimaryHref: "/hizmetler#paketler",
    ctaSecondary: "Hizmetler",
    ctaSecondaryHref: "/hizmetler",
    secondTrack: {
      kicker: "İkinci hat · paketlerden ayrı",
      title: "POL-TURK Danışmanlık — Polonya ticaret aracılığı",
      body: "Yurtdışındaki Türk şirketlerine pazar / firma analizi, lojistik ürün analizi ve fiyat teklifi köprüsü. Ana gelir hattımız şu an yazı özeti ve idari takip paketleridir.",
      ctaLabel: "Ticaret masası için yazın",
      href: "#iletisim",
    },
    demo: {
      label: "Örnek özet kart",
      footnote: "Örnek — gerçek dosyanızda alanlar değişir.",
  ...
  bridge: {
    ...
    title: "Bilgi kurumdan size, dilinizde ve takipte",
    intro:
      "Üç şerit: kurum yazar, POL-TURK açıklar ve takip eder, siz karar verirsiniz. Hukuki karar avukat ortağında kalır.",
    lanes: [
      {
        id: "kurum",
        label: "Kurum",
        body: "Urząd, ZUS, US veya banka resmi yazı veya talep gönderir — dil çoğu zaman Lehçe.",
      },
      {
        id: "pol-turk",
        label: "POL-TURK",
        body: "Yazıyı dilinizde özetleriz, son tarih ve sıradaki adımı netleştiririz, dosyayı takip ederiz.",
      },
      {
        id: "siz",
        label: "Siz",
        body: "Kapsamı onaylar, belgeyi sağlarsınız; karar ve imza sizde veya yetkili ortağınızda kalır.",
      },
    ],
    lawyerNote:
      "Avukat ortağı ayrı şerittedir: hukuki tavsiye, temsil ve tescil orada kalır — POL-TURK bu şeride girmez.",
  },
  audiences: {
    eyebrow: "Kim için",
    ...
    items: [
      ...
      },
      {
        ...
        points: [
          "Başvuru ve kayıt evrak listesi (bilgilendirme)",
  ...
  categories: {
    ...
    intro:
      "Üç ücretli paket ile yatırım/kuruluş danışmanlığı, işletme masası, eğitim idaresi ve şahıs urzęd hattı. Tümü idari danışmanlıktır; hukuki tavsiye, tescil ve vergi imzası dahil değildir.",
    items: [
      {
        id: "yazi-ozeti",
        icon: "FileText",
      ...
      },
      {
        ...
        body: "Ay boyunca gelen yazılar; ödeme sonrası dosya sayfası / İş masası’nda durum; aşım net.",
        packageSlug: "aylik-paket",
        href: "/hizmetler/aylik-paket",
        ctaLabel: "Aylık paket",
        badge: "Paket",
      },
      {
        id: "vekaletli",
  ...
  packages: {
    ...
    intro:
      "Üç paket: Tek yazı, Aylık takip, Vekaletli yürütme. Ödeme sonrası dosya açılır.",
    applyLabel: "Başvur",
    detailLabel: "Detay",
    featuredStory: {
      title: "Ay boyunca",
  ...
  process: {
    ...
    intro:
      "Elinizde kurum yazısı varsa siteden yazı paketi alın. Telefon görüşmesi şu an sunulmuyor; yazılı paketler veya yerinde eşlik için iletişim formu. Yerinde eşlik: form, sonra kapsam.",
    paidPathTitle: "Ücretli paketlerde dört adım",
    steps: [
      {
        title: "Paketi seçin",
        body: "Yazı paketlerinde resmi yazıyı (PDF / fotoğraf) ekleyin.",
      },
      {
        title: "Ödeme",
    ...
    consultPathBody:
      "Telefon görüşmesi şu an sunulmuyor. Yerinde eşlik: form veya iletişim → kapsam → uygun yazı veya vekalet paketi. Sohbet ücretsiz sonsuz destek değildir. Onay veya süre garantisi yoktur.",
    consultSteps: [
      {
        title: "Form veya iletişim",
        body: "Hizmet: eşlik — şahıs veya firma. Şehir, kurum, uzaktan mı yerinde mi yazın.",
      },
      {
        title: "Kapsam",
        body: "Hangi iş, hangi dil, vekalet gerekir mi — yazılı netleştirilir.",
      },
      {
        title: "Paket ve ödeme",
        body: "Yazılı paketler: tek yazı, aylık veya vekaletli. Yerinde eşlik bu paketlerle yürütülür.",
      },
      {
        title: "Teslimat",
        body: "Uzaktan bilgilendirme veya yerinde eşlik, paketin parçası olarak; not dosyaya yazılır.",
      },
    ],
    ctaPackage: "Paketlere git",
    ctaConsult: "Görüşme formu",
  },
  cases: {
    eyebrow: "Örnek durumlar",
    title: "Sık gelen işler",
    intro: "Garanti veya hukuki sonuç vaadi değildir — tipik kullanım.",
    tabs: [
      {
        id: "us-zus",
        label: "US / ZUS yazısı",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Eksik evrak kontrolü (bilgilendirme)",
  ...
  scope: {
    ...
    included: [
      ...
      "Son tarih ve sıradaki adım netliği",
      "Eğitim / üniversite sürecinde idari yönlendirme (bilgilendirme)",
  ...
  faq: faqTr,
  lead: {
    title: "Kısa görüşme veya paket sorusu",
    intro:
      "Acil yazı: üst menüden Başvur. Telefon görüşmesi şu an sunulmuyor. Yerinde eşlik: bu form (eşlik — şahıs veya firma). Dönüş genelde 1 iş günü.",
    fullName: "Ad Soyad",
...
export const landingPl: LandingContent = {
  ...landingTr,
  meta: {
    title: "POL-TURK | Most administracyjny PL — pisma, tracking, doradztwo",
    description:
      "Przedsiębiorcy z Turcji: inwestycja, założenie spółki i działalność w Polsce — doradztwo administracyjne i inicjacja procesu. MŚP, osoby, urzędy. TR / PL / EN / RU / UK. Nie jesteśmy kancelarią.",
  },
  brand: {
    name: "POL-TURK",
    tagline: "Wyjaśniamy pismo, śledzimy sprawę",
    secondName: "POL-TURK Doradztwo",
  },
  nav: [
  ...
  hero: {
    eyebrow: "Polska · korporacyjne doradztwo administracyjne",
    title: "Sprawy urzędowe w Polsce przy jednym stole",
    subtitle:
      "Inwestycja, założenie spółki i korespondencja urzędowa: most językowy, tracking i koordynacja z adwokatem-partnerem. TR / PL / EN.",
    valueLine:
      "Nie jesteśmy kancelarią, biurem rachunkowym ani tłumaczem przysięgłym. Wpis i reprezentacja u polskiego partnera adwokackiego; my: doradztwo administracyjne i tracking.",
    ctaPrimary: "Pakiety",
    ctaPrimaryHref: "/hizmetler#paketler",
    ctaSecondary: "Usługi",
    ctaSecondaryHref: "/hizmetler",
    secondTrack: {
      kicker: "Druga linia · osobno od pakietów",
      title: "POL-TURK Doradztwo — pośrednictwo handlowe w Polsce",
      body: "Dla tureckich firm za granicą: analiza rynku / firm, analiza logistyki produktu i pośrednictwo w wycenie. Główny przychód na start: pakiety streszczeń pism i trackingu.",
      ctaLabel: "Napisz w sprawie handlu",
      href: "#iletisim",
    },
    demo: {
      label: "Przykładowa karta",
      footnote: "Przykład — pola zależą od sprawy.",
  ...
  bridge: {
    eyebrow: "Co robimy",
    title: "Informacja z urzędu do Państwa — w Waszym języku, ze śledzeniem",
    intro:
      "Trzy pasy: instytucja pisze, POL-TURK wyjaśnia i śledzi, Państwo decydujecie. Decyzja prawna zostaje u adwokata-partnera.",
    lanes: [
      {
        id: "kurum",
        label: "Instytucja",
        body: "Urząd, ZUS, US lub bank wysyła pismo albo wezwanie — zwykle po polsku.",
      },
      {
        id: "pol-turk",
        label: "POL-TURK",
        body: "Streszczamy pismo w Waszym języku, termin i kolejny krok; prowadzimy teczkę.",
      },
      {
        id: "siz",
        label: "Państwo",
        body: "Zatwierdzacie zakres, dostarczacie dokumenty; decyzja i podpis zostają u Was lub u uprawnionego partnera.",
      },
    ],
    lawyerNote:
      "Adwokat-partner jest osobnym pasem: porada prawna, reprezentacja i wpis zostają tam — POL-TURK w ten pas nie wchodzi.",
  },
  audiences: {
    eyebrow: "Dla kogo",
    title: "Linie usług",
    ...
    items: [
      ...
      },
      {
        ...
        points: [
          "Checklist dokumentów (informacyjnie)",
  ...
  categories: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Pisma w miesiącu; po płatności status na stronie sprawy / Koncie; overage jasny.",
        packageSlug: "aylik-paket",
        href: "/hizmetler/aylik-paket",
      ...
      },
      {
        ...
        body: "Porządek dokumentacji i mapa procesu przy edukacji — informacyjnie.",
        href: "/hizmetler/egitim",
  ...
  packages: {
    ...
    intro:
      "Trzy pakiety: Jedno pismo, Opieka miesięczna, Prowadzenie z POA. Po płatności otwiera się sprawa.",
  ...
  process: {
    eyebrow: "Jak działa",
    title: "Dwie ścieżki — pakiet lub konsultacja",
    intro:
      "Macie pismo — pakiet na stronie. Konsultacja telefoniczna nie jest obecnie dostępna; pakiety pisemne lub towarzyszenie na miejscu — formularz kontaktowy. Towarzyszenie na miejscu: formularz, potem zakres.",
    paidPathTitle: "Cztery kroki w pakietach płatnych",
    steps: [
      {
        title: "Wybierzcie pakiet",
        body: "Przy pismach — PDF / zdjęcie.",
      },
      {
        title: "Płatność",
    ...
    consultPathBody:
      "Konsultacja telefoniczna nie jest obecnie dostępna. Towarzyszenie na miejscu: formularz lub kontakt → zakres → właściwy pakiet. To nie darmowy support. Bez gwarancji decyzji.",
    consultSteps: [
      {
        title: "Formularz lub kontakt",
        body: "Usługa: towarzyszenie — osoba lub firma. Miasto, urząd, zdalnie czy na miejscu.",
      },
      {
        title: "Zakres",
        body: "Jaka sprawa, język, czy potrzebne pełnomocnictwo — na piśmie.",
      },
      {
        title: "Pakiet i płatność",
        body: "Pakiety pisemne: jedno pismo, miesięczny lub POA. Towarzyszenie na miejscu w ramach tych pakietów.",
      },
      {
        title: "Dostawa",
        body: "Informacja zdalna lub towarzyszenie na miejscu — w ramach pakietu; notatka w teczce.",
      },
    ],
    ctaPackage: "Do pakietów",
    ctaConsult: "Formularz kontaktowy",
  },
  cases: {
    eyebrow: "Przykłady",
    title: "Typowe sprawy",
    intro: "Bez gwarancji wyniku — typowe użycie.",
    tabs: [
      {
        id: "us-zus",
        label: "US / ZUS",
      ...
      },
      {
        ...
        bullets: [
          "Kolejność dokumentów (informacyjnie)",
  ...
  lead: {
    ...
    intro:
      "Pilne pismo: menu «Złóż wniosek». Konsultacja telefoniczna nie jest obecnie dostępna. Towarzyszenie na miejscu: ten formularz. Odpowiedź zwykle 1 dzień.",
...
export const landingEn: LandingContent = {
  ...landingTr,
  meta: {
    title: "POL-TURK | Poland admin bridge — letters, tracking, advisory",
    description:
      "Turkish business operators: investing in Poland, company formation and activity launch — administrative advisory and process initiation. SMEs, individuals, offices. TR / PL / EN / RU / UK. Not a law firm.",
  },
  brand: {
    name: "POL-TURK",
    tagline: "We explain official letters and keep the process in view",
    secondName: "POL-TURK Advisory",
  },
  nav: [
  ...
  accountLink: "Sign in",
  hero: {
    eyebrow: "Poland · corporate administrative advisory",
    title: "Polish official processes at one desk",
    subtitle:
      "Investment, company formation and office correspondence: language bridge, tracking and coordination with the lawyer partner. TR / PL / EN.",
    valueLine:
      "We are not a law firm, tax adviser or sworn translator. Registration and legal representation stay with the Polish lawyer partner; we provide administrative advisory and process tracking.",
    ctaPrimary: "Packages",
    ctaPrimaryHref: "/hizmetler#paketler",
    ctaSecondary: "Services",
    ctaSecondaryHref: "/hizmetler",
    secondTrack: {
      kicker: "Second track · separate from packages",
      title: "POL-TURK Advisory — Poland trade intermediary",
      body: "For Turkish companies abroad: market / company analysis, logistics product analysis and price-quote bridging. Near-term revenue focus: letter-summary and admin-tracking packages.",
      ctaLabel: "Contact about trade desk",
      href: "#iletisim",
    },
    demo: {
      label: "Sample summary card",
      footnote: "Example — fields vary by file.",
  ...
  bridge: {
    eyebrow: "What we do",
    title: "From the authority to you — in your language, with tracking",
    intro:
      "Three lanes: the institution writes, POL-TURK explains and tracks, you decide. Legal decisions stay with the lawyer partner.",
    lanes: [
      {
        id: "kurum",
        label: "Authority",
        body: "An office, ZUS, tax office or bank sends an official letter or request — usually in Polish.",
      },
      {
        id: "pol-turk",
        label: "POL-TURK",
        body: "We summarise the letter in your language, clarify deadline and next step, and keep the file moving.",
      },
      {
        id: "siz",
        label: "You",
        body: "You approve scope and supply documents; decisions and signatures stay with you or your authorised partner.",
      },
    ],
    lawyerNote:
      "The lawyer partner is a separate lane: legal advice, representation and registration stay there — POL-TURK does not enter that lane.",
  },
  audiences: {
    ...
    items: [
      ...
      },
      {
        ...
        points: [
          "Enrolment document checklist (informational)",
  ...
  categories: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Letters through the month; after payment, status on the case page / Account; clear overage.",
        packageSlug: "aylik-paket",
        href: "/hizmetler/aylik-paket",
        ctaLabel: "Monthly plan",
        badge: "Package",
      },
      {
        id: "vekaletli",
      ...
      },
      {
        ...
        body: "Documentation order and process map for education paths — informational.",
        href: "/hizmetler/egitim",
  ...
  packages: {
    ...
    intro:
      "Three packages: Single letter, Monthly tracking, POA execution. A case opens after payment.",
    applyLabel: "Apply",
    detailLabel: "Details",
    featuredStory: {
  ...
  process: {
    ...
    title: "Two paths — package or consult",
    intro:
      "Have a letter — buy a letter package on the site. Phone consultation is not available right now; use a written package or the contact form for on-site accompaniment. On-site: form first, then scope.",
    paidPathTitle: "Four steps for paid packages",
    steps: [
      {
        title: "Pick a package",
        body: "Letter packages: PDF / photo.",
      },
      {
        title: "Payment",
    ...
    consultPathBody:
      "Phone consultation is not available right now. On-site accompaniment: form or contact → scope → the right letter or POA package. Not unlimited free support. No decision guarantee.",
    consultSteps: [
      {
        title: "Form or contact",
        body: "Pick accompaniment — individual or company. City, office, remote or on site.",
      },
      {
        title: "Scope",
        body: "What the job is, language, whether a POA is needed — in writing.",
      },
      {
        title: "Package and payment",
        body: "Written packages: single letter, monthly or POA. On-site accompaniment runs under those packages.",
      },
      {
        title: "Delivery",
        body: "Remote information or on-site accompaniment as part of the package; notes go on the file.",
      },
    ],
    ctaPackage: "Go to packages",
    ctaConsult: "Contact form",
  },
  cases: {
    eyebrow: "Examples",
    title: "Common situations",
    intro: "Not a promise of outcome — typical use.",
    tabs: [
      {
        id: "us-zus",
        label: "Tax / ZUS",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Missing-document check (informational)",
  ...
  lead: {
    title: "Short contact",
    intro:
      "Urgent letter: header Apply. Phone consultation is not available right now. On-site accompaniment: this form. Reply usually in 1 business day.",
    fullName: "Full name",

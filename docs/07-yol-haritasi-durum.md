...
**Durum:** Kanonik · **2026-09-10** · Harici analiz: `pol-turk-analiz-ve-yol-haritasi.md`
...
| 3 Test/CI | **Tamam** | Yerel Postgres smoke (isteğe bağlı; ajan Docker açmaz) |
| 4 Canlı | **Kod tamam** | Marka, domain, Stripe live, RODO imza |
| 5 Gelir | **Kod tamam** | Checkout: dört SKU (`telefon-gorusme` 150 zł/saat); yatırım/kuruluş = lead |
| 6 Ölçek | Ertelendi | Talep kanıtlanırsa |

**Kod yol haritası kapanış sürümü:** `0.8.2-exp` (kamu metin + go-live kapısı). Canlı = operatör checklist.
